  ...
  Stream<GSDUploadFileProgress> _uploadFile(GSDUploadFile file,
    ...
    try {
      if (file.isImage && file.resolution != null && !kIsWeb) {
        ...
        file.setFilePath(resizedImagePath);
      }

      RestAPIFileUploadController controller = await _restApiManager
          .uploadFileWithController(file.filePath.isEmpty ? "" : file.filePath,
              webFile: file.filePath.isEmpty ? file.platfromFile : null,
