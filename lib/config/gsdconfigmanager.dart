...
abstract class GSDConfigManager {
  ...
  /// Callback, der aufgerufen wird, nachdem sensible Konfigurationsdaten erfolgreich gespeichert wurden.
  Function()? onSecureConfigSaved;

  GSDConfigManager._({this.backgroundMode = false, this.onSecureConfigSaved});
