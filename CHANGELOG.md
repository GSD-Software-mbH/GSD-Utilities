...
## 0.0.37
* ConfigManager Hintergrundmodus hinzufügen. (Damit in IOS nicht auf die KeyChain geschrieben wird wenn die App im hintergrund ist)

## 0.0.36
* ConfigManager Secure Storage Problem

## 0.0.35
* ConfigManager Secure Storage Problem
* Konfigurationsverwaltung aktualisiert um SharedPreferences für öffentliche Daten und FlutterSecureStorage für sensible Daten zu verwenden; shared_preferences Abhängigkeit hinzugefügt 
...
* gsd_restapi version updaten
* CI-Update
* Flutter secure storage version auf 10.0.0 aktualisiert

## 0.0.24
* GSDNotificationsHelper für Web-Benachrichtigungen hinzugefügt
* Browser-Erkennung (Chrome, Edge, Firefox, Safari)
* Notification-Berechtigungsmanagement (anfordern, Status prüfen)
* showNotification() für Web-Browser
* Automatisches Schließen nach 5 Sekunden
* Plattform-spezifische Implementierung (Web vs. Native)
* Vollständiges Example mit interaktiver Demo
