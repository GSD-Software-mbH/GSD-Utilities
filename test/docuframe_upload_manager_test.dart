...
void main() {
  group('DOCUframeUploadManager Tests', () {
    ...
    setUp(() {
      ...
      // Erstelle DOCUframeApi mit tatsächlichen Parametern
      ...
      uploadManager = DOCUframeUploadManager(api.v1.documents);
    });

    tearDown(() async {
      // Runtime der neuen API nach jedem Test freigeben
      await api.dispose();
    });
